require("auto-session").setup({
  ...
  -- The following are already the default values, no need to provide them if these are already the
  -- settings you want.
  session_lens = {
    ...
    -- list of buffer types what should not be deleted from current session.
    buftypes_to_ignore = {},
