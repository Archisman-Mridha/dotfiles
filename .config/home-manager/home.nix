...

{
  ...
  home.username = "archismanmridha";
  home.homeDirectory = "/Users/archismanmridha";
  ...
  # Home Manager is pretty good at managing dotfiles. The primary way to manage plain files is through
  # home.file.
  home.file = {
    # Building this configuration will create a copy of dotfiles/.zshrc in the Nix store.
    # Activating the configuration will then make ~/.zshrc a symlink to the Nix store copy.
